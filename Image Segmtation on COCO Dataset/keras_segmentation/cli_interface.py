...
def cli_train():
	...
	parser.add_argument("--optimizer_name", type = str , default = "adamax")

	args = parser.parse_args()


	#assert not args.model_name is None , ""
	#assert not args.train_images is None , ""
	#assert not args.train_annotations is None , ""
	#assert not args.n_classes is None , ""
